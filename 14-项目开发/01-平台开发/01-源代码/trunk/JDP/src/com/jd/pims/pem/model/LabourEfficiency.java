...
@Entity
public class LabourEfficiency extends BaseDataModel implements
		Comparable<LabourEfficiency> {
	/**
	 * 
	 */
	...
	@Override
	public int compareTo(LabourEfficiency o) {

		if (this.getBizDate().getTime() > o.getBizDate().getTime()) {
			return 1;
		} else if (this.getBizDate().getTime() < o.getBizDate().getTime()) {
			return -1;
		} else {
			return 0;
		}
